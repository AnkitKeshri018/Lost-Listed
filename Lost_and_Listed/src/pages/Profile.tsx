...
const Profile = () => {
  ...
  const handleProductDeleteItem = async (item: any) => {
    try {
      await axios.delete(`/api/v1/products/delete/${item._id}`, {
        withCredentials: true,
      });
  ...
  const MarkasSold = async (i: any) => {
    try {
      const res = await axios.put(`/api/v1/products/sold/${i._id}`);
  ...
  const MarkasAvailable = async (i: any) => {
    try {
      const res = await axios.put(`/api/v1/products/unsold/${i._id}`);
  ...
  return (
    <div>
      <Navbar />
      <div className="min-h-screen bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100 p-6 animate-fade-in-up">
        {/* Header Profile Section */}
        <div className="bg-white dark:bg-gray-900 shadow p-6 rounded-xl flex flex-col sm:flex-row gap-6 items-center sm:items-start text-gray-900 dark:text-gray-100 transition-all duration-300 animate-fade-in hover:shadow-2xl hover:scale-[1.00]">
          {/* Avatar Section */}
          <div className="relative group transition-all duration-300">
            <img
              src={user.avatar?.url || "/default-avatar.png"}
              className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border shadow object-cover transition-all duration-300 group-hover:scale-105"
            />
            <label
          ...
          <div className="hidden sm:flex gap-3">
            {["lost", "found", "claims", "products"].map((tab) => (
              <Button
                ...
                className={
                  activeTab == tab
                    ? "bg-purple-600 hover:purple-500"
                    : "bg-white hover:bg-gray-100 hover:text-black dark:bg-gray-900 dark:hover:text-white dark:hover:bg-gray-700"
                }
        ...
        {/* CONTENT */}
        <div className="mt-4 bg-white dark:bg-gray-900 p-4 sm:p-6 rounded-xl shadow space-y-4">
            ...
            <>
              ...
              <div className="flex justify-end mb-4">
                <Input
                  ...
                  value={searchLost}
                  onChange={(e) => setSearchLost(e.target.value.toLowerCase())}
              ...
              {lostItems && lostItems.length > 0 ? (
                ...
                <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                  <p className="text-lg font-semibold">No lost items found.</p>
                  <p className="text-sm">
            ...
            <>
              ...
              <div className="flex justify-end mb-4">
                <Input
                  ...
                  value={searchFound}
                  onChange={(e) => setSearchFound(e.target.value.toLowerCase())}
                  className="max-w-sm bg-gray-100 dark:bg-gray-800"
                />
              </div>
              ...
              {foundItems && foundItems.length > 0 ? (
                ...
                <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                  <p className="text-lg font-semibold">No found items yet.</p>
                  <p className="text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end mb-4">
                <Input
                  ...
                  value={searchClaim}
                  onChange={(e) => setSearchClaim(e.target.value.toLowerCase())}
                  className="max-w-sm bg-gray-100 dark:bg-gray-800"
                />
              </div>
                ...
                return filtered.map((a: any) => (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-300">
                      <p>
                        <strong>Type:</strong>{" "}
                        {claimsTab === "claimed" ? "Found Item" : "Lost Item"}
                      </p>
                    </div>

                    <Badge
                      className={`w-fit mx-auto text-white rounded-full px-3 py-1 ${
                        claimsTab === "claimed" ? "bg-blue-500" : "bg-green-600"
                      }`}
                    >
                      {claimsTab === "claimed"
                        ? "You claimed it"
              ...
              {userProducts && userProducts.length > 0 ? (
                userProducts.filter(
                        ...
                        <div className="flex justify-end">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                              ...
                              {!i.isSold ? (
                                <DropdownMenuItem onClick={() => MarkasSold(i)}>
                                  Mark as Sold
                                </DropdownMenuItem>
                              ) : (
                                <DropdownMenuItem
                  ...
                  <div className="text-center py-10 text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-sm">Try using a different keyword.</p>
                  </div>
                )
              ) : (
                ...
                <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">Start by listing an item for sale.</p>
                </div>
              )}
            </>
          )}
