  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2 text-green-600 dark:text-green-500">Found Items</h1>
        ...
        <div className="mb-6">
          <Button onClick={handleAddClick} variant="secondary" className="gap-2">
          ...
          <main>
            {filteredItems.length === 0 ? (
              <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed p-12 text-center">
                ...
                <p className="text-muted-foreground">
                  Try adjusting your filters or be the first to report a found item
                </p>
              </div>
            ) : (
